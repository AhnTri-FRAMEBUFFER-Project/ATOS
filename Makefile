...
#Makes everything up
make_deafult: bboot atclib kernel ccalc irq timer fb tty qemudrivers serialdrivers advset cbot cal credit art artii fishdic game notes osver keychar gdt idt fsa ld buildgrub

#Build kernel main image
kernel: main.c
	gcc -m32 -c main.c -o image.o -std=gnu99 -ffreestanding -O1 -Wall -Wextra 
#Link everything up
ld: linker.ld linker.ld clib.o image.o framebuffer.o tty.o irq.o irq_s.o timer.o ccalc.o qemu.o serial.o advset.o cbot.o isr.o cal.o art.o artii.o notes.o osver.o fishdic.o credit.o game.o char.o boot.o gdt.o load_gdt.o idt.o load_idt.o fs.o
	ld -m elf_i386 -T linker.ld clib.o image.o framebuffer.o tty.o irq.o irq_s.o timer.o advset.o ccalc.o qemu.o serial.o cbot.o isr.o cal.o art.o artii.o notes.o osver.o fishdic.o credit.o game.o char.o boot.o gdt.o load_gdt.o idt.o load_idt.o fs.o -o ATOS1.bin -nostdlib
...
#Link everything up
ld_vm: linker.ld linker.ld imagei.o ccalc.o fb.o tty.o advset.o cbot.o cal.o artii.o notes.o osver.o fishdic.o credit.o game.o char.o boot.o gdt.o load_gdt.o idt.o load_idt.o
	ld -m elf_i386 -T linker.ld imagei.o ccalc.o fb.o tty.o advset.o cbot.o cal.o artii.o notes.o osver.o credit.o fishdic.o game.o utils.o char.o boot.o gdt.o load_gdt.o idt.o load_idt.o -o ATOS2.bin -nostdlib
